const tr = {
  ...
  hasFile: "✓ Dosya var",
  pfDraft: "Taslak aç",
  pfConfirm: "Onayla ve üretime gönder",
  pfRetry: "Tekrar dene",
  pfTrack: "Kargo takibi",
  pfStatus: { draft: "Taslak", pending: "Onaylandı", inprocess: "Üretimde", shipped: "Kargoda", failed: "Hata", canceled: "İptal", on_hold: "Beklemede", needs_access: "Adres izni bekleniyor", error: "Hata", fulfilled: "Tamamlandı" } as Record<string, string>,
  front: "⬇ Ön",
  back: "⬇ Arka",
  noFile: "Dosya yok",
...
const en: typeof tr = {
  ...
  qty: (n) => `${n}× pcs`,
  hasFile: "✓ File ready",
  pfDraft: "Create draft",
  pfConfirm: "Confirm and send to production",
  pfRetry: "Try again",
  pfTrack: "Tracking",
  pfStatus: { draft: "Draft", pending: "Confirmed", inprocess: "In production", shipped: "Shipped", failed: "Failed", canceled: "Canceled", on_hold: "On hold", needs_access: "Waiting for address permission", error: "Error", fulfilled: "Fulfilled" } as Record<string, string>,
  front: "⬇ Front",
  back: "⬇ Back",
  noFile: "No file",
