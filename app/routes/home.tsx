  ...
  tr: {
    ...
    templates: {
      ...
      items: [
        ...
        { img: "calendar-art", tag: "Üretici", t: "Özel gün takvimi", p: "Seçilen ayın takvimi; özel gün kalp, daire ya da yıldızla işaretli, başlık ve isimlerle." },
        { img: "moonphase-art", tag: "Üretici", t: "Ay evresi", p: "Tanıştığınız, doğduğun ya da evlendiğiniz gecenin gerçek ayı; tek tarih ya da üç özel gün." },
        { img: "wordsearch-art", tag: "Üretici", t: "Kelime avı bulmacası", p: "İsimler ve anılar harf tablosuna gizlenir; istenirse kelimeler bulunmuş hâliyle işaretli basılır." },
        { img: "qrcode-art", tag: "Üretici", t: "QR kod", p: "Düğün videosu, şarkı listesi, mesaj ya da Wi-Fi bilgisi okutulabilir bir QR koda dönüşür." },
      ],
      extras: [
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: "Pro", amt: "49.99", cur: "$", desc: "Yüksek hacimli mağazalar için.", feat: ["2.000 sipariş/ay", "4 ürün kategorisi", "1.500 arka plan kaldırma/ay", "✦ 450 yapay zeka görseli/ay", "20 özel şablon", "Üretim & Gang Sheet", "Öncelikli destek"], cta: "Pro'yu başlat", featured: false },
        { name: "Business", amt: "99", cur: "$", desc: "Daha büyük ekipler için.", feat: ["Sınırsız sipariş", "Sınırsız ürün kategorisi", "4.000 arka plan kaldırma/ay", "✦ 900 yapay zeka görseli/ay", "Sınırsız özel şablon", "Üretim & Gang Sheet", "Özel onboarding & destek"], cta: "14 gün ücretsiz başla", featured: false },
      ],
    },
    faq: {
      ...
      items: [
        ...
        { q: "Hazır şablonları nasıl kullanıyorum?", a: "Kişileştirici sayfasında şablon türünü seçersiniz (fotoğraf şablonu, kelime sanatı, şarkı, yıldız haritası, şehir haritası, monogram, doğum çiçeği, takvim, ay evresi, kelime avı, QR kod, tekrarlı desen, yapay zeka portre). Font, renk ve seçenekleri ayarlayıp şablonu bir veya birden çok ürüne bağlarsınız. Müşteri ürün sayfasında bilgilerini girer, baskı dosyası sunucuda üretilir." },
  ...
  en: {
    ...
    templates: {
      ...
      items: [
        ...
        { img: "calendar-art", tag: "Generator", t: "Special date calendar", p: "A calendar of the chosen month with the special day marked by a heart, circle or star, plus a title and names." },
        { img: "moonphase-art", tag: "Generator", t: "Moon phase", p: "The real moon on the night you met, were born or got married — a single date or three special days." },
        { img: "wordsearch-art", tag: "Generator", t: "Word search puzzle", p: "Names and memories hidden in a letter grid, optionally printed with the words already circled." },
        { img: "qrcode-art", tag: "Generator", t: "QR code", p: "A wedding video, playlist, message or Wi-Fi details become a scannable QR code." },
      ],
      extras: [
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: "Pro", amt: "49.99", cur: "$", desc: "For higher-volume stores.", feat: ["2,000 orders/month", "4 product categories", "1,500 background removals/month", "✦ 450 AI images/month", "20 custom templates", "Production & Gang Sheet", "Priority support"], cta: "Start Pro", featured: false },
        { name: "Business", amt: "99", cur: "$", desc: "For larger teams.", feat: ["Unlimited orders", "Unlimited product categories", "4,000 background removals/month", "✦ 900 AI images/month", "Unlimited custom templates", "Production & Gang Sheet", "Custom onboarding & support"], cta: "Start free for 14 days", featured: false },
      ],
    },
    faq: {
      eyebrow: "FAQ",
      ...
      items: [
        ...
        { q: "How do I use the ready-made templates?", a: "On the Personalizer page you choose a template type (photo template, word art, song, star map, city map, monogram, birth flower, calendar, moon phase, word search, QR code, repeat pattern, AI portrait). Set the fonts, colors and options, then link the template to one or more products. Customers enter their details on the product page and the print file is rendered on the server." },
