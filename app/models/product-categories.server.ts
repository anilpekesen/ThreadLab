...
export async function getCategoriesForShop(shop: string): Promise<ProductCategory[]> {
...
export async function getCategoryById(id: string, shop: string): Promise<ProductCategory | null> {
  const result = await query<ProductCategory>(
...
export async function getCategoryCount(shop: string): Promise<number> {
...
export async function canCreateCategory(shop: string): Promise<{ allowed: boolean; used: number; limit: number; planKey: PlanKey }> {
...
export async function updateCategory(
  ...
  if (!fields.length) return getCategoryById(id, shop);
...
export async function deleteCategory(id: string, shop: string): Promise<void> {
  await query(
