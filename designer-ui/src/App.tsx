...
export default function App() {
  ...
  const handleAddToCart = async () => {
    ...
    // Add one surcharge cart line priced at the combined total across all
    // selected sizes. Cart Transform fixes that line to quantity 1, so
    // checkout reads "Tasarım Baskı Ücreti × 1" while totals stay correct.
    if (personalization.surchargeVariantId) {
      ...
      if (surchargeUnitTl > 0) {
        ...
        const surchargeTotal = Math.round(surchargeUnitTl * totalQty * 100) / 100;
