...
export const en: { [K in keyof typeof tr]: string } = {
  ...
  aiPromptHelp: 'You can write in your own language. Describe the objects, composition, and mood together: single-piece emblem, centered, streetwear, print design, and similar details.',
